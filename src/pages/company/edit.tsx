...
export const EditPage = () => {
  const {
    ...
    formProps,
    formLoading,
    queryResult } = useForm({ // connect the form from ant design 
      redirect: false,
      meta: {
  ...
  const { selectProps: selectPropsUsers, queryResult: queryResultUsers } = useSelect<GetFieldsFromList<UsersSelectQuery>>({
    resource: "users",
    optionLabel: 'name',
    pagination: {
      mode: "off"
